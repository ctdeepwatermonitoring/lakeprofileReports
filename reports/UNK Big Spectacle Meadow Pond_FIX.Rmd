...
output:
  html_document:
    ...
    css: style.css
params:
  location: UNK Big Spectacle Meadow Pond
---
<div class = "section">
...
WQPIDs <- unique(site$WQPID) #for URL
...
<b>`r f_location`</b> is a <b>`r acres` acre</b> lake, located in the town of <b>`r town`</b> within <b>`r county` County</b>, Connecticut. The max measured depth of this lake is <b>`r depth` meters</b>. It has been sampled by <a href = "https://portal.ct.gov/deep/water/inland-water-monitoring/lake-water-quality-monitoring">CT DEEP Water Monitoring and Assessment</a> on <b>`r samplingdays`</b> sampling day(s) between <b>`r firstdate`</b> and <b>`r lastdate`</b>.

The DEEP Water Monitoring Program conducts ambient monitoring and the <a href = "https://portal.ct.gov/deep/water/water-quality/water-quality-305b-report-to-congress">related assessments of the State’s waters</a>, including Connecticut's many lakes and ponds.  In Connecticut, there are a total of 2,267 lakes and ponds greater than 10 acres in size. 
...
The below results are first grouped according to the monitoring location, and then according to the date they were sampled. Click <a href = "https://www.waterqualitydata.us/data/Result/search?organization=CT_DEP01_WQX&project=lakesABM&project=lakesNLA`r WQPIDs`&mimeType=csv&zip=no&dataProfile=resultPhysChem&providers=NWIS&providers=STORET">here</a> to download the water chemistry profile data associated with these monitoring location(s).
