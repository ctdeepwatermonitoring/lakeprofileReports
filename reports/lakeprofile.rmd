...
These results are first grouped according to the monitoring location, and then according to the date they were sampled. Click <a href = "https://www.waterqualitydata.us/data/Result/search?organization=CT_DEP01_WQX&project=lakesABM&project=lakesNLA`r WQPIDs`&mimeType=csv&zip=no&dataProfile=resultPhysChem&providers=NWIS&providers=STORET">here</a> to download the water chemistry profile data associated with these graphs.
